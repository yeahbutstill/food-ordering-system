package com.yeahbutstill.food.ordering.system.kafka.consumer.config;

import com.yeahbutstill.food.ordering.system.kafka.config.data.KafkaConfigData;
import com.yeahbutstill.food.ordering.system.kafka.config.data.KafkaConsumerConfigData;
...
public class KafkaConsumerConfig<K extends Serializable, V extends SpecificRecordBase> {
    ...
    /***
     * ini untuk membuat default kafka consumer dan meneruskan konfigurasi consumer sebagai parameter
     * @return
     */
    @Bean
